参考: https://blog.csdn.net/qq_34764487/article/details/78412285
#### score.txt
```java
C1 90
C2 56
...
object GroupTop3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val lines = sc.textFile("/Users/dali/Downloads/score.txt",1)
    val pairs = lines.map(_.split(" ")).map(line => (line(0), line(1)))
    val groupPairs = pairs.groupByKey()

    val top3Score = groupPairs.map(x => (x._1,x._2.toList.sorted.reverse.take(3)))
    for(score <- top3Score){
